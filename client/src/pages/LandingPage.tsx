...
function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f0f4f8]">
      <nav className="bg-white shadow px-4 sm:px-8 py-4 flex justify-between items-center">
        ...
        <div className="flex gap-2 sm:gap-3">
          <button
            ...
            className="px-3 sm:px-5 py-2 border border-gray-300 rounded text-gray-700 hover:bg-gray-50 text-xs sm:text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400"
          >
            Iniciar Sesión
          </button>
          <button
            ...
            className="px-3 sm:px-5 py-2 bg-blue-700 text-white rounded hover:bg-blue-800 text-xs sm:text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400"
          >
            Registrarse
          </button>
        </div>
      ...
      <section className="flex flex-col items-center justify-center text-center py-16 sm:py-24 px-4 sm:px-6">
      ...
      <section
        className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-4 sm:px-8 pb-24"
