              ...
              <>
                ...
                <div className="mt-6 text-center">
                  <p className="text-sm text-neutral-600">
                    ...
                    <Link to="/register" className="text-primary-700 hover:text-primary-900 font-semibold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 rounded px-1 focus:outline-none">
                      Regístrate aquí
                    </Link>
                  </p>
                </div>
                ...
                <form className="space-y-5" onSubmit={handleReset} noValidate>
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        id="resetEmail" type="email" value={resetEmail}
                  ...
                  <button
                    type="submit" disabled={resetSubmitting}
                    className="w-full px-6 py-3 bg-blue-800 hover:bg-blue-900 disabled:opacity-50 text-white font-semibold rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400"
                  >
